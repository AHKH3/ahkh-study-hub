...
window.__ahkhBootReader = function (vars) {
  ...
  function renderGutterNote(item) {
    ...
    if (span.closest('.hidden') || span.offsetParent === null) {
  ...
  function updateCompletionButton(isCompleted) {
    ...
    if (isCompleted) {
      ...
      btn.classList.add('border-emerald-200/80', 'dark:border-emerald-800/40');
      ...
      btn.classList.remove('border-emerald-200/80', 'dark:border-emerald-800/40');
