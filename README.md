<div align="center">
  ...
  *Transforming dense educational curricula into enduring, readable literature through the art of HTML & CSS.*
  ...
  [**Live Website**](https://ahkh3.github.io/ahkh-study-hub/) · [**Architecture Docs**](docs/ARCHITECTURE.md) · [**Decisions Log**](docs/DECISIONS.md) · [**Project Specs**](docs/PROJECT.md) · [**Global Design System**](DESIGN.md)
</div>
